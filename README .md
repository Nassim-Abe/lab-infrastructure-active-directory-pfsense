...
- Centraliser l’authentification dans le domaine `corp.lan` (NetBIOS `CORP`) avec `DC01`, contrôleur inscriptible hébergeant AD DS, DNS et DHCP.
...
3. Installer AD DS/DNS/DHCP sur DC01 et créer `corp.lan` ([installation AD DS](docs/02-installation-ad-ds.md)).
