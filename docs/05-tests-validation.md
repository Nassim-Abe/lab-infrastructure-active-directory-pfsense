...
La GPO **Corporate Wallpaper** peut utiliser `\\DC01\NETLOGON\wallpaper\corp.jpg`. Contrôler le poste dans l’OU attendue, le lien GPO, SYSVOL/NETLOGON et mesurer une application en moins de 90 secondes. Répéter depuis OPT1 avec CLT01.
...
| Connectivité | pings et `nslookup` depuis OPT1 avec CLT01 |
